...
* \class CComPort
*
* \brief This class implements the CommunicationPort interface for Windows and Linux.
*
* \author  Central Labs
* \date 09/07/2010
* \version Version 2.0.3: improved Linux support for physical interfaces
*
...
#include "../Include/CComPort_noQt.h"
#include <stdio.h>
